...
import 'package:note/lib/signup_screen.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../constants.dart';

class XDiPhoneXXS11Pro1 extends StatefulWidget {
...
class _loginScreen extends State<XDiPhoneXXS11Pro1> {
                  ...
                  MaterialButton(
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        ...
                        dynamic result = await _auth.signInUser(email, pasword);
