...
import 'package:note/lib/review_edit.dart';
import 'package:rating_bar/rating_bar.dart';

class Review_list extends StatefulWidget {
  _review_list createState() => _review_list();
}

class _review_list extends State<Review_list> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            IconButton(
              onPressed: () {
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => Cart_list()));
              },
              icon: Icon(
                Icons.shopping_cart,
      ...
      body: StreamBuilder(
        stream: cart_repo.doc(u_uid).collection("review").snapshots(),
        builder: (BuildContext context, snapshot) {
          if (!snapshot.hasData) {
            ...
            return Center(
              child: Text("No Data ${snapshot.hasError}"),
            );
